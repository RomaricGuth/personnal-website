  ...
  return (
    ...
    >
      <div className="flex flex-col flex-wrap break-words max-w-xl">
        <Motion animation="slideIn" transition={{ delay: 0.2 }}>
          <h1 className="text-6xl font-bold tracking-tight">{t("name")}</h1>
        </Motion>
        <Motion animation="slideIn" transition={{ delay: 0.4 }}>
          <div className="text-5xl leading-tight font-hand mt-4">
            {t("job1")}
          </div>
        </Motion>
        <Motion animation="slideIn" transition={{ delay: 0.6 }}>
          <div className="flex flex-col sm:flex-row gap-6 mt-12 w-full">
